package com.gameszaum.core.spigot.api.title;
...
public class Title {
    ...
    public static void sendTitle(Player player, String title, String subTitle) {
        sendTitle(player, title, subTitle, 5, 50, 5);
    }

    public static void sendSubTitle(Player player, String subTitle) {
        sendTitle(player, null, subTitle, 5, 50, 5);
    }
    
    public static void sendTitle(Player player, String title) {
        sendTitle(player, title, null, 5, 50, 5);
    }
